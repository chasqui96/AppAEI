...
class FragmentHigieneTres : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_higiene_tres, container, false)
        ...
        mediaPlayer1 = MediaPlayer.create(context, R.raw.lavarselacara)
        ...
        // Inicializa el MediaPlayer con el archivo de sonido
        mediaPlayer2 = MediaPlayer.create(context, R.raw.cepillarse)
