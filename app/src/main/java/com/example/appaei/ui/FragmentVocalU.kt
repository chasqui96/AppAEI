...
class FragmentVocalU : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_vocal_u, container, false)
        val playButton: Button = view.findViewById(R.id.image_start_button)

        // Inicializa el MediaPlayer con el archivo de sonido
        mediaPlayer = MediaPlayer.create(context, R.raw.letra_u)
        ...
        val openDialogButtonE: Button = view.findViewById(R.id.open_dialog_button_u)
        openDialogButtonE.setOnClickListener {
            val dialog =
                LetterDrawingDialogFragment.newInstance(R.drawable.letra_u) // Cambia por la imagen de la letra E
