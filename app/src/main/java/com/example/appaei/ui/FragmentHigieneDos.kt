...
class FragmentHigieneDos : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_higiene_dos, container, false)
        ...
        mediaPlayer1 = MediaPlayer.create(context, R.raw.lavarselasmanos)
        ...
        // Inicializa el MediaPlayer con el archivo de sonido
        mediaPlayer2 = MediaPlayer.create(context, R.raw.banharse)
