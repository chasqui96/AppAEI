...
class FragmentVocalI : Fragment() {
    ...
    override fun onCreateView(
        ...
        mediaPlayer = MediaPlayer.create(context, R.raw.letra_i)
        ...
        openDialogButtonE.setOnClickListener {
            val dialog = LetterDrawingDialogFragment.newInstance(R.drawable.letra_i) // Cambia por la imagen de la letra E
