...
class FragmentColorVarios: Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_color_varios, container, false)

        // Encuentra el botón por su ID
        val playButton: Button = view.findViewById(R.id.image_start_button)

        // Inicializa el MediaPlayer con el archivo de sonido
        mediaPlayer = MediaPlayer.create(context, R.raw.varioscoloressonuido)
        ...
        val openLocalButton: Button = view.findViewById(R.id.open_varios_colores)
        openLocalButton.setOnClickListener {
            val videoUri =
                Uri.parse("android.resource://" + requireContext().packageName + "/" + R.raw.varios_colores)
