...
class FragmentSentidoPrimero : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_sentido_primero, container, false)

        // Encuentra el botón por su ID
        val playButton: Button = view.findViewById(R.id.image_start_button)

        // Inicializa el MediaPlayer con el archivo de sonido
        mediaPlayer = MediaPlayer.create(context, R.raw.los_sentiods)
        ...
        openYouTubeButton.setOnClickListener {
            val videoUrl = "a_EfwFzm1ys&t"  // Ejemplo de URL de YouTube
