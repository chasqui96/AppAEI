...
import com.example.appaei.ui.LetterDrawingDialogFragment.Companion.ARG_LETTER

class FragmentEmocionDibujar : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_emocion_dibujar, container, false)

        // Encuentra el botón por su ID
        val playButton: Button = view.findViewById(R.id.image_start_button)

        // Inicializa el MediaPlayer con el archivo de sonido
        mediaPlayer = MediaPlayer.create(context, R.raw.coloazul_principa)
        ...
        val letterResId =  R.drawable.lasemocionesdibujarr // Valor por defecto
